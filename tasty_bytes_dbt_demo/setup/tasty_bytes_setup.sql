...
CREATE OR REPLACE FILE FORMAT common.csv_ff 
type = 'csv';

CREATE OR REPLACE STAGE common.s3load
COMMENT = 'Quickstarts S3 Stage Connection'
url = 's3://sfquickstarts/frostbyte_tastybytes/'
file_format = common.csv_ff;
...
FROM @common.s3load/raw_pos/country/;

-- franchise table load
COPY INTO raw.franchise
FROM @common.s3load/raw_pos/franchise/;

-- location table load
COPY INTO raw.location
FROM @common.s3load/raw_pos/location/;

-- menu table load
COPY INTO raw.menu
FROM @common.s3load/raw_pos/menu/;

-- truck table load
COPY INTO raw.truck
FROM @common.s3load/raw_pos/truck/;

-- customer_loyalty table load
COPY INTO raw.customer_loyalty
FROM @common.s3load/raw_customer/customer_loyalty/;

-- order_header table load
COPY INTO raw.order_header
FROM @common.s3load/raw_pos/order_header/;

-- order_detail table load
COPY INTO raw.order_detail
FROM @common.s3load/raw_pos/order_detail/;
